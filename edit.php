...
$update="update users set first_name='".$first_name."', last_name='".$last_name."', phone='".$phone."', password='".$password."', county='".$county."', address='".$address."', quantity='".$quantity."', season='".$season."', utype='".$utype."', type='".$type."' where id='".$id."'";
